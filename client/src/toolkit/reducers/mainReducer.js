...
export const getAllClients = createAsyncThunk(
    'getAllClients',
    () => {
        return fetch('/api/get_all_clients')
...
export const getClientInfo = createAsyncThunk(
    ...
    (clientId) => {
        ...
        return fetch('/api/get_client_info', options)
            .then(response => response.json())
            .then(result => result)
...
export const getOrderInfo = createAsyncThunk(
    ...
    (clientId) => {
        ...
        return fetch('/api/get_order_info', options)
            .then(response => response.json())
            .then(result => result)
            .catch(error => console.log('fetch client info error --->', error))
    }
...
export const getAllClientInfo = createAsyncThunk(
    ...
    (clientId) => {
        ...
        return fetch('/api/get_all_client_info', options)
            .then(response => response.json())
            .then(result => result)
            .catch(error => console.log('fetch client info error --->', error))
    }
...
export const addClient = createAsyncThunk(
    ...
    (clientData) => {
        ...
        return fetch('/api/add_client', options)
            .then(response => {
...
export const addOrder = createAsyncThunk(
    ...
    ({clientId, orderData},) => {
        ...
        return fetch('/api/add_order', options)
            .then(response => {
                if (response.status === 200)
                    return fetch('/api/get_all_clients')
                        .then(response => response.json())
...
export const searchClient = createAsyncThunk(
    ...
    (clientName) => {
        ...
        return fetch('/api/search_client', options)
            .then(response => response.json())
            .then(result => result)
...
export const changeClientInfo = createAsyncThunk(
    ...
    (clientData) => {
        ...
        return fetch('/api/change_client_info', options)
            .then(response => {
                if (response.status === 200)
                    return fetch('/api/get_all_client_info', options_1)
                        .then(response => response.json())
                        .then(result => result)
                        .catch(error => console.log('fetch client info error --->', error))
...
export const changeOrderInfo = createAsyncThunk(
    ...
    (orderData) => {
        ...
        return fetch('/api/change_order_info', options)
            .then(response => {
                if (response.status === 200)
                    return fetch('/api/get_all_client_info', options_1)
                        .then(response => response.json())
...
export const destroyOrder = createAsyncThunk(
    ...
    (destroyData) => {
        ...
        return fetch('/api/destroy_order', options)
            .then(response => {
                if (response.status === 200)
                    return fetch('/api/get_all_client_info', options_1)
                        .then(response => response.json())
...
export const destroyClient = createAsyncThunk(
    ...
    (clientId) => {
        ...
        return fetch('/api/destroy_client', options)
            .then(response => {
                if (response.status === 200)
                    return fetch('/api/get_all_clients')
                        .then(response => response.json())
...
export const isDone = createAsyncThunk(
    ...
    (isDoneData) => {
        ...
        return fetch('/api/is_done_order', options)
            .then(response => {
                if (response.status === 200)
                    return fetch('/api/get_all_client_info', options_1)
                        .then(response => response.json())
