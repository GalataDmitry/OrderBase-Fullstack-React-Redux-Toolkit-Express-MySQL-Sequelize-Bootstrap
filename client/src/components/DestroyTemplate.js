...
import {destroyOrder} from "../toolkit/reducers/mainReducer"
...
const DestroyTemplate = ({id}) => {
    ...
    return <>
        <button onClick={() => dispatch(DESTROY_DATA({id, clientId}))}
                ...
                <div className="modal-content" style={{backgroundColor: '#282c34'}}>
                    ...
                    <div className="modal-body">
                        ...
                        <div className="row">
                            <div className="col">
                                <button
                                    onClick={() => dispatch(destroyOrder(destroyData))}
...
export default DestroyTemplate